...
def correct_fail(total_guesses):
    if total_guesses > 6:
        ...
        print('\nCongratulations you guessed correctly, You Win! It only took', total_guesses, 'guess!')
    else:
        print('\nCongratulations you guessed correctly, You Win! It only took', total_guesses, 'guesses!')
